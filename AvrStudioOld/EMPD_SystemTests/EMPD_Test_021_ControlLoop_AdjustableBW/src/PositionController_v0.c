...
parameter Real mp1=pi*R1^2*d1*rhoAlu;
parameter Real Jp1=(1/2)*mp1*R1^2;  //massatraagheid poelie 1 [kgm2]
parameter Real d2=0.02;
parameter Real mp2=pi*R2^2*d2*rhoAlu;
parameter Real Jp2=(1/2)*mp2*R2^2;  //massatraagheid poelie 2
parameter Real Ras=0.006;
parameter Real Las=0.02;
parameter Real mas=pi*Ras^2*Las*rhoSUS;
parameter Real Jas=(1/2)*mas*Ras^2; //massatraagheid reductoras [kgm2]
